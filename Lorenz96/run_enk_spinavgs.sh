...
#SBATCH --mem=100G                  # GigaBytes of memory required (per node)
...
python -u run_lorenz96_EnK_spinavgs.py ${alg_NO} ${mdl_NO} ${ensbl_size} #> ${alg_name}_${mdl_name}_J${ensbl_size}.log