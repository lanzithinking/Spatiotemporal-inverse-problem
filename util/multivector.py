...
cpp_module = df.compile_cpp_code(cpp_code, include_dirs=include_dirs)
...
class MultiVector(cpp_module.MultiVector):
    ...
    def _exportXDMF(self, Vh, filename, varname, normalize):
        """
        Specialization of export using df.File
        """
        fid = df.XDMFFile(Vh.mesh().mpi_comm(), filename)
        fid.parameters["functions_share_mesh"] = True
        fid.parameters["rewrite_function_mesh"] = False
        
        fun = df.Function(Vh, name = varname)
