...
PYBIND11_MODULE(SIGNATURE, m) {
    py::class_<dolfin::MultiVector>(m, "MultiVector")
		...
		.def("__getitem__", (std::shared_ptr<const dolfin::GenericVector> (dolfin::MultiVector::*)(std::size_t) const) &dolfin::MultiVector::operator[] )
		.def("__setitem__", (std::shared_ptr<dolfin::GenericVector> (dolfin::MultiVector::*)(std::size_t)) &dolfin::MultiVector::operator[] )
		...
		.def("scale", (void (dolfin::MultiVector::*)(std::size_t, double)) &dolfin::MultiVector::scale,
			 "Assign self[k] *= a",
			 py::arg("k"), py::arg("a"))
