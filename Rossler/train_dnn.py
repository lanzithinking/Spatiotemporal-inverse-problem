...
# custom_loss = lambda y_true, y_pred: [tf.abs(loglik(y_true)-loglik(y_pred)), (y_true-y_pred)/rsl.misfit.nzvar]
# custom_loss = lambda y_true, y_pred: [tf.math.reduce_sum((y_true-y_pred)**2/rsl.misfit.nzvar,axis=1), None]
# dnn=DNN(x_train.shape[1], y_train.shape[1], depth=depth, node_sizes=node_sizes, droprate=droprate,
