'''
Likelihood of the Advection-Diffusion problem written in FEniCS-2019.1.0 and hIPPYlib-3.0
...
class SpaceTimePointwiseStateObservation(Misfit):
    ...
    def __init__(self, Vh, observation_times=None, targets=None, rel_noise = 0.01, d = None, **kwargs):
        ...
        # TODO: define STGP kernel for the likelihood
        self.stgp=STGP(spat, temp=self.observation_times)
