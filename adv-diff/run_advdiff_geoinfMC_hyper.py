...
def main(seed=2020):
    ...
    parser.add_argument('step_sizes', nargs='?', type=float, default=[.001,.001,.007,None,None]) # [.001,.005,.005] simple likelihood model
    ...
    engy=np.zeros((args.num_samp+args.num_burnin,3))
