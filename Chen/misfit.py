...
'''
The misfit of Chen inverse problem 
-------------------------------------------------------------------------
...
class misfit:
    """
    Misfit for Chen inverse problem.
    """
    def __init__(self, ode=None, obs_times=None, **kwargs):
        """
        ode: Chen object
        obs_times: time points where observations are taken
        true_params: true parameters of Chen for which observations are obtained
        ...
        """
        self.ode = chen(**kwargs) if ode is None else ode
